 ...
 *
 * The application trains a Decision Tree classifier on the SMS Spam Collection dataset. It performs
 * basic text cleaning, vectorisation using TF-IDF and reports accuracy and F1 metrics on a hold-out
 * test set.
 */
